...
\item 
struct \mbox{\hyperlink{structiocbQueue}{iocb\+Queue}}
\item 
...
\begin{DoxyCompactItemize}
\item 
\mbox{\Hypertarget{dataStructs_8h_a51110a2b468e9946e9b166632ffcd2fc}\label{dataStructs_8h_a51110a2b468e9946e9b166632ffcd2fc}} 
typedef struct \mbox{\hyperlink{structalarm}{alarm}} {\bfseries alarm\+\_\+struct}
\item 
...
\item 
\mbox{\Hypertarget{dataStructs_8h_aa754026b253ae613a49d66699b80225c}\label{dataStructs_8h_aa754026b253ae613a49d66699b80225c}} 
typedef struct \mbox{\hyperlink{structiocbQueue}{iocb\+Queue}} {\bfseries iocb\+Queue}
\item 
\mbox{\Hypertarget{dataStructs_8h_a9f13420f11076a0617c67cb84c236dcc}\label{dataStructs_8h_a9f13420f11076a0617c67cb84c236dcc}} 
typedef struct \mbox{\hyperlink{structdcb}{dcb}} {\bfseries dcb}
\item 
\mbox{\Hypertarget{dataStructs_8h_aa35e18b1f482eadaaa3a5186223ea2f2}\label{dataStructs_8h_aa35e18b1f482eadaaa3a5186223ea2f2}} 
typedef struct \mbox{\hyperlink{structiocb}{iocb}} {\bfseries iocb}
\end{DoxyCompactItemize}
\doxysubsection*{Enumerations}
\begin{DoxyCompactItemize}
\item 
\mbox{\Hypertarget{dataStructs_8h_a015eb90e0de9f16e87bd149d4b9ce959}\label{dataStructs_8h_a015eb90e0de9f16e87bd149d4b9ce959}} 
enum {\bfseries status} \{ {\bfseries O\+P\+EN}, 
{\bfseries C\+L\+O\+S\+ED}
 \}
\item 
\mbox{\Hypertarget{dataStructs_8h_aee84adc8774b423febdd2ac4b0b2a634}\label{dataStructs_8h_aee84adc8774b423febdd2ac4b0b2a634}} 
enum {\bfseries eflag} \{ {\bfseries I\+N\+C\+O\+M\+P\+L\+E\+TE}, 
...
void \mbox{\hyperlink{dataStructs_8h_a49e9a9de34a2683cee2725f4178fa923}{iocb\+Enqueue}} (\mbox{\hyperlink{structiocbQueue}{iocb\+Queue}} $\ast$q, \mbox{\hyperlink{structiocb}{iocb}} $\ast$new\+I\+O\+CB)
\begin{DoxyCompactList}\small\item\em Adds a new I\+O\+CB to the queue. \end{DoxyCompactList}\item 
...
\mbox{\hyperlink{structiocb}{iocb}} $\ast$ \mbox{\hyperlink{dataStructs_8h_a91cc4b81074a1f25dbdc688255930853}{iocb\+Dequeue}} (\mbox{\hyperlink{structiocbQueue}{iocb\+Queue}} $\ast$q)
\begin{DoxyCompactList}\small\item\em Removes a I\+O\+CB from the front of the queue. \end{DoxyCompactList}\item 
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
Returns the removed I\+O\+CB
\end{DoxyReturn}
Checks if the queue is empty (Head is N\+U\+LL). Creates a temp I\+O\+CB to point to the head. If heads next exists, set head to point to head next and returns the temp I\+O\+CB which points to the old head. Otherwise the queue only has 1 item so the head and tail are set to N\+U\+LL and we return temp \mbox{\Hypertarget{dataStructs_8h_a49e9a9de34a2683cee2725f4178fa923}\label{dataStructs_8h_a49e9a9de34a2683cee2725f4178fa923}} 
\index{dataStructs.h@{dataStructs.h}!iocbEnqueue@{iocbEnqueue}}
\index{iocbEnqueue@{iocbEnqueue}!dataStructs.h@{dataStructs.h}}
\doxysubsubsection{\texorpdfstring{iocbEnqueue()}{iocbEnqueue()}}
{\footnotesize\ttfamily void iocb\+Enqueue (\begin{DoxyParamCaption}\item[{\mbox{\hyperlink{structiocbQueue}{iocb\+Queue}} $\ast$}]{q,  }\item[{\mbox{\hyperlink{structiocb}{iocb}} $\ast$}]{new\+I\+O\+CB }\end{DoxyParamCaption})}



Adds a new I\+O\+CB to the queue. 
...
\hline
\end{DoxyParams}
Receives a new I\+O\+CB and an existing queue. Checks if the queue is empty by checking if the head and tail pointers are null. If so the new I\+O\+CB is the new head and tail. Checks the priortiy of the I\+O\+CB received and itterates through the queue until we find processes with the same priority. Process that have the same priority are first in first out. The last I\+O\+CB with the same priority now has its next pointer looking at the I\+O\+CB we are inserting. The new I\+O\+CB next now looks at the old next of the last I\+O\+CB with the same priority. \mbox{\Hypertarget{dataStructs_8h_a63c16934c9d95f3583cf09891d18c095}\label{dataStructs_8h_a63c16934c9d95f3583cf09891d18c095}} 
